...
export default function RelatedServiceCard({
  ...
  return (
    <div
      className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 cursor-pointer group min-w-[280px] my-2"
      onClick={() =>
